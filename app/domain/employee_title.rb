module Domain
	class EmployeeTitle
		...
		def generate_seniority
			seniorities = ["VP", "Director", "President", "Chairman", "Head"]
		...
		def generate_department
			departments = ["Engineering", "QA", "Security", "Sales", "Marketing", "Business", "Product", "Content", "Machine Learning", "Science"]
			@randomizer.random_element_of(departments)
		end
		
		def generate_specialty
			seniorities = ["Operations", "Strategy", "Innovation", "Development"]
